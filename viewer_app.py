...
class SimpleViewerApp:
    ...
    def render_imgui_overlay(self) -> None:
        ...
        if self.state in {"triangle", "rectangle", "pentagon", "hexagon", "circle", "ellipse", "trapezoid", "star", "arrow", "cube", "surface", "model"}:
            if self.state == "triangle":
                ...
                active_shape = "Pentagon"
            elif self.state == "hexagon":
                active_shape = "Hexagon"
            elif self.state == "circle":
                active_shape = "Circle"
            elif self.state == "ellipse":
                active_shape = "Ellipse"
            elif self.state == "trapezoid":
                active_shape = "Trapezoid"
            elif self.state == "star":
                active_shape = "Star"
            elif self.state == "arrow":
                active_shape = "Arrow"
    ...
    def _on_pick_texture(self) -> bool:
        ...
        try:
            ...
            return False
        # for scene in (self.triangle_scene, self.cube_scene, self.surface_scene):
        #     if getattr(scene, "mode", None) == RenderMode.TEXTURE:
        #         pass
        return True
